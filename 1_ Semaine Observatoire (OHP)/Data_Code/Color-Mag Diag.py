...
############# Extinction #############
Av=0.8 #E=0.310 => Av=0.961 apparemment
Ab=1.337*Av
Ar=0.7505*Av
...
VRmag3=Vmag3 - (Rmag3)
BVmag3=Bmag3 - (Vmag3)
VRmag3C=Vmag3-Av - (Rmag3-Ar)
BVmag3C=Bmag3-Ab - (Vmag3-Av)
...
plt.scatter(AxeX,AxeY,c='red',edgecolor='none',s=1,marker='o')
plt.scatter(AxeX2,AxeY2,c='black',edgecolor='none',s=1,marker='o')
# =============================================================================
